// Brand marks for the quiet rail. Self-contained SVG paths (official GitHub /
// LinkedIn / X glyphs) so the rail keeps one consistent weight and does not lean
// on lucide's deprecated brand icons. Decorative: each is aria-hidden because
// the wrapping link/span already carries the accessible label.
